...
export default function Landing() {
    ...
    return (
        <div data-testid="landing-page" className="bg-background">
                    ...
                    <div className="space-y-7">
                        ...
                        <div className="flex flex-col gap-3 pt-2">
                            ...
                            <p className="text-sm text-muted-foreground max-w-xl">
                                Esta página es para quienes <strong className="font-medium text-foreground">producen eventos</strong>.
                                ¿Querés <strong className="font-medium text-foreground">comprar entradas</strong>?{" "}
                                <Link to="/o/demo-org" className="text-primary underline underline-offset-2">
                                    Ver eventos de demo
                                </Link>
                                .
                            </p>
            ...
            {/* Plans */}
            <section id="planes" className="mx-auto max-w-6xl px-5 sm:px-8 py-16">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 pt-2">
                            {plans.map((p) => (
                                <PlanCard
                                    key={p.id}
                                    plan={p}
                                    onSelect={(plan) => navigate(`/registro?plan=${plan.code}`)}
                                    ctaLabel="Elegir y registrarme"
                                />
                            ))}
                        </div>
                    )}
